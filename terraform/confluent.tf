...
# # ------------------------------------------------------
# # DLQ Topic for Data Contract Violations
# # ------------------------------------------------------

# resource "confluent_kafka_topic" "clickstream-topic" {
#   kafka_cluster {
...
# resource "confluent_kafka_topic" "invalid_messages_dlq" {
#   kafka_cluster {
#     id = confluent_kafka_cluster.standard.id
#   }

#   topic_name       = "invalid-messages"
#   partitions_count = 3
#   rest_endpoint    = confluent_kafka_cluster.standard.rest_endpoint
#   config = {
...
# resource "confluent_schema" "avro-clickstream" {
...
#   subject_name  = "clickstream-value"
#   format        = "AVRO"
#   schema        = file("${path.module}/clickstream_schema_v1.avsc")
#   hard_delete   = true
#   credentials {
...
#       on_failure = "DLQ"
#       params = {
#         "dlq.topic"      = confluent_kafka_topic.invalid_messages_dlq.topic_name
#         "dlq.auto.flush" = "true"
#       }
#     }
#   }
